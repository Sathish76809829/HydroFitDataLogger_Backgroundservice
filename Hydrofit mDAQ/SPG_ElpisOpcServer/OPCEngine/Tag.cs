...
namespace Elpis.Windows.OPC.Server
{
    ...
    public class Tag : SerializableDependencyObject, ITag, INotifyPropertyChanged
    {
        ...
        public string TagName
        {
            get
            {
                if (BlockType == BlockTypes.Select)
                {
                    return tagName;
                }
                else
        ...
        [Description("Specify the identity of the SignalId."), Browsable(false), DisplayName("SignalId *")]
        ...
        //            Address = ADC.ch0.ToString(); // Set initial value based on ADC enum
        //            break;
        //        case ChannelType.RPM:
        //            Address = RPM.ch13.ToString(); // Set initial value based on RPM enum
        //            break;
        //        case ChannelType._2AMS:
        //            Address = _2AMS.ch15.ToString(); // Set initial value based on _2AMS enum
        //            break;
        //        default:
        //            Address = "";
        //            break;
        ...
        //[Description("Specify the channeltype"),DisplayName("ChannelType *"), Browsable(true),PropertyOrder(3)]
        //public ChannelType ChannelType
        //{
        //    set
        //    {
        ...
        [Description("Indicate the rights the client has in accessing the data."), Browsable(false), DisplayName("Data Access"), DefaultValue(11)]
