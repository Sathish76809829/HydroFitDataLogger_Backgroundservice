...
namespace ElpisOpcServer
{
    ...
    public partial class AddNewTagUI : Window
    {
        ...
        public AddNewTagUI(dynamic Device)
        {
            ...
            //var properties = Device.GetType().GetProperties(System.Reflection.BindingFlags.Instance |
        ...
        public AddNewTagUI(object Device, ObservableCollection<TagGroup> groups)
        {
            InitializeComponent();
            ...
            //tag.TagId = SelectedDevice.DeviceId + "s" + tagcount;
            //tagcount++;
